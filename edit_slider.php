<?php  
    ...
    $data = $connection->query("SELECT * FROM `slide` where id=$id");
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-header">
                                    <div class="card-title">UPDATE_SLIDER MENU</div>
                                </div>
                                <!--end::Header-->
                                ...
                                <form action="save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Slider Heading</label>
                                            <input type="text" class="form-control" name="sliderheading" 
                                            value="<?= $r['slider_heading']; ?>"/>

                                        </div>

                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Slider
                                                Description</label>
                                            <textarea name="sliderdescription" class="form-control" rows="5"></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option value="1" <?= ($r['status'] == 1) ? 'selected' : '' ?>>Enable
                                            </option>
                                            <option value="0" <?= ($r['status'] == 0) ? 'selected' : '' ?>>Disable
                                            </option>
                                        </select>
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary" name="sliderupdate">Update</button>
                            </div>
                            </form>
                            <!--end::Footer-->
