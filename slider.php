<?php  
    ...
    $data = $connection->query("SELECT * FROM `slide` ");
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card card-primary card-outline mb-4">
                                ...
                                <div class="card-header">
                                    <div class="card-title">SLIDER MENU</div>
                                </div>
                                <!--end::Header-->
                                ...
                                <form action="save.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary"
                                            name="slidersubmit">Submit</button>
                                    </div>
                                    <!--end::Footer-->
                                </form>
                                <!--end::Form-->
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        ?>
                                            ...
                                            <tr class="align-middle">
                                                <td><?= $i; ?></td>
                                                <td><img src="<?= $r['slider_image']; ?>" alt=""
                                                        style="height:100px; width:100px;"></td>
                                                <td><?= $r['slider_name']; ?></td>
                                                <td><?= $r['slider_heading']; ?></td>
                                                <td>
                                                    <textarea name="" id=""
                                                        class="form-control"><?= $r['slider_description']; ?></textarea>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="edit_slider.php?edit_id=<?= $r['id']; ?>"
